...
// Custom in-component translations for the dashboard
const translations = {
  en: {
    title: "Registration Fee",
    description: "To start using the platform and accepting bookings, please pay the initial registration fee.",
  ...
  mn: {
    ...
    description: "Платформыг ашиглаж эхлэх болон захиалга авахын тулд бүртгэлийн хураамжаа төлнө үү.",
    amountLabel: "Бүртгэлийн дүн",
    bankNameLabel: "Банк",
...
interface ChefPaymentDialogProps {
  isOpen: boolean;
  onOpenChange: (open: boolean) => void;
  chefName: string;
}

export function ChefPaymentDialog({
  isOpen,
  onOpenChange,
  chefName,
}: ChefPaymentDialogProps) {
  ...
  const reference = `REG-${chefName.toUpperCase().replace(/\s+/g, "-")}`;
